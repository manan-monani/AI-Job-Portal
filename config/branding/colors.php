...
$primary = '#179753ff'; // Primary Brand Color (Emerald Green)
$primary_light = '#ecfdf5'; // Green 50 (soft mint background)
$primary_dark_text = '#6ee7b7'; // Green 300 (readable in dark mode)

$sidebar_rail_bg = '#064e3b'; // Deep emerald (linked to primary)
$sidebar_rail_bg_dark = '#022c22'; // Very dark green
