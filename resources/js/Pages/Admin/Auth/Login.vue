            ...
            <div class="relative z-10 max-w-lg text-center lg:text-left">
                ...
                >
                    <img
                        ...
                        class="h-full w-full rounded-2xl object-contain p-2"
                    />
                ...
                <h1 class="mb-6 text-4xl leading-tight font-bold lg:text-6xl">{{ __($page.props.branding.admin_login?.headline) }}</h1>
        ...
        <div class="relative flex items-center justify-center bg-white p-6 transition-colors duration-300 md:p-8 lg:w-1/2 dark:bg-gray-900">
            <div class="w-full max-w-md">
                ...
                >
                    ...
                    <div class="grid grid-cols-2 divide-x divide-slate-100 dark:divide-gray-700">
                        <div class="p-4">
                            ...
                            <div class="truncate text-sm font-medium text-slate-600 dark:text-slate-300">admin@admin.com</div>
                        </div>
                        <div class="p-4">
                ...
                <div class="mt-6 text-center">
                    ...
                    >
                        <svg class="mr-1 h-4 w-4 rotate-180 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                        </svg>
                        {{ __($page.props.branding.admin_login?.login_as_customer) }}
                    </a>
                </div>
            </div>
        </div>
